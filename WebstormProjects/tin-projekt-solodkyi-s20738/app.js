...
const pracownikiApiRouter = require('./routes/api/PracownikiApiRoute');
const pracaApiRouter = require('./routes/api/PracaApiRoute');
...
app.use('/api/pracowniki',pracownikiApiRouter);
app.use('/api/praca',pracaApiRouter);
