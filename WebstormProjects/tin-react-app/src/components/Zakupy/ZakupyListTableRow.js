        ...
        <tr>
            ...
            <td>
                <ul className="list-actions">
                    <li><Link to={'zakups/details/' + zakupy.id_sklep_klient} className="list-actions-button-details">Szczególy</Link></li>
                    <li><Link to={'zakups/edit/' + zakupy.id_sklep_klient} className="list-actions-button-edit">Edit</Link></li>
                    <li><Link to={'zakups/delete/' + zakupy.id_sklep_klient} className="list-actions-button-delete">Usuń</Link>
                    </li>
                </ul>
            </td>
        </tr>
